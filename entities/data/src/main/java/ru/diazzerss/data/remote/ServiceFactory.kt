...
object ServiceFactory {
    inline fun <reified API> makeService(baseUrl: String, isDebug: Boolean): API {
    ...
    inline fun <reified API> makeService(baseUrl: String, okHttpClient: OkHttpClient, gson: Gson): API {
